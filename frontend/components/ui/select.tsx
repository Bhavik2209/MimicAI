...
import { CheckBold, ChevronDownBold, ChevronUpBold } from 'solar-icon-set/react/solid'
  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDownBold className="size-4 opacity-50" />
...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpButton
      ...
      {...props}
    >
      <ChevronUpBold className="size-4" />
    </SelectPrimitive.ScrollUpButton>
  )
}
...
function SelectScrollDownButton({
  ...
  return (
    <SelectPrimitive.ScrollDownButton
      ...
      {...props}
    >
      <ChevronDownBold className="size-4" />
    </SelectPrimitive.ScrollDownButton>
  )
}
